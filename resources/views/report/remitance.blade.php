...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="row ml-4" style="margin-top: 100px; position: relative;">
                    @if($remitance->voucher_print>0)
                    <img
                        src="{{ asset('image/duplicate.png') }}"
                        alt="dup"                        
                        style="position: absolute; opacity: 0.07; right:35%; top:-50%; width: 40%;"
                    />
                    @endif
                <div class="col-6">
