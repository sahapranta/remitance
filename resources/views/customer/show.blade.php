    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <span class="text-muted pb-3">Created by: {{$customer->User->name}} | at:
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @endif
                                        <b-dropdown split size="sm" split-variant="outline-primary" variant="primary" text="Print" class="m-2">
                                            <b-dropdown-item href="{{route('report.remitance', $remitance->id)}}">Remitance</b-dropdown-item>
