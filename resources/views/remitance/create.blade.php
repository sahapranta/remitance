                ...
                <form action="{{route('remitance.store')}}" method="POST" class="p-3">
                    ...
                    <div class="form-group">
                        <input type="text" placeholder="Sender Name" class="form-control @error('sender') is-invalid @enderror"
                            name="sender" value="{{ old('sender') }}" required autocomplete="sender">
                        @error('sender')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <select placeholder="Payment By" class="form-control @error('payment_by') is-invalid @enderror"
                                    name="payment_by" value="{{ old('payment_by') }}" required >
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                <select class="form-control @error('payment_by') is-invalid @enderror" name="payment_type">
