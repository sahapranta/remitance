<template>
  <div>
    <select name="sending_country" v-model="country" class="form-control">
      <option value selected>Select Country</option>
      <option v-for="(cn, i) in countryName" :value="cn.name" :key="i">{{cn.name}}</option>
    </select>
  </div>
</template>
